...
const handleRegistration = async () => {
    ...
    try {
      ...
      console.error(error);
      errorMessage = 'Überprüfe erneut deine Daten. Bitte gib eine gültige E-Mail ein. Das Passwort muss mindestens 8 Zeichen lang sein, mind. einen Groß- und einen Kleinbuchstaben, mind. eine Zahl und mind. ein Sonderzeichen enthalten.';
    }
  };
...
<div class="registration-container">
  <form on:submit|preventDefault={handleRegistration} class="registration-form">
    <div class="card p-4 max-h-[400px] overflow-auto space-y-4">
      ...
      <label class="label">
        ...
        <input class="input" title="birthDate" type="text" bind:value={birthDate} on:input={handleBirthDateInput}
      ...
      <label class="label">
        <span>Biografie</span>
        <textarea bind:value={bio} class="textarea" rows="4" placeholder="Erzähle uns etwas über dich"></textarea>
      </label>
      <br>
      <div class="btn">
        <button class="btn variant-filled" type="submit">
